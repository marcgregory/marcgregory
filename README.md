...
I have hands-on experience integrating AWS services such as Simple Email Service (SES) for transactional email delivery and EventBridge for event-driven workflows. I’ve also worked with other third-party libraries and APIs, including the Movider SMS API for messaging services, the Bux API for financial transaction processing, and PostgreSQL for managing relational databases.
